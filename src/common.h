...
/**
 * 以字符delimiter为分界切分字符串，非常优雅的实现方式
 * 但需要注意: 如果字符串分界点前后有多余空格，分切结果会有带空格，如："a, b" 切分结果为 {"a", " b"} 
 */ 
